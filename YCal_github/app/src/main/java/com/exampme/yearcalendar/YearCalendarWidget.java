...
import andropackage com.exampme.yearcalendar;
...
public class YearCalendarWidget extends AppWidgetProvider {
    ...
    public static class SettingsActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (saved > 0) {
                // Читаем сохранённую дату в UTC, чтобы отобразить ту же дату в пикере
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Сохраняем UTC-полдень: запас ±12ч гарантирует,
                    // что переход летнего/зимнего времени не сдвинет дату
                    Calendar sel = Calendar.getInstance(java.util.TimeZone.getTimeZone("UTC"));
                    sel.set(dp.getYear(), dp.getMonth(), dp.getDayOfMonth(), 12, 0, 0);
